...
rem python mod_piotr022_rssi_sbar.py temp\fw.dec.bin
...
rem python mod_custom_freq_ranges.py temp\fw.dec.bin
rem python mod_custom_noaa_freqs.py temp\fw.dec.bin

rem python mod_custom_steps.py temp\fw.dec.bin
rem python mod_more_freq_steps_and_backlight_duration.py temp\fw.dec.bin
