...
current_noaa = struct.unpack_from('<10I', fw, offset=0xE180) ; print('Old noa freqs:', [f'{i*10} Hz' for i in current_noaa])
...
current_noaa = struct.unpack_from('<10I', fw, offset=0xE180) ; print('New noa freqs:', [f'{i*10} Hz' for i in current_noaa])
